...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/BMPageViewController/BMPageViewController.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Bolts/Bolts.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ConvenienceKit/ConvenienceKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/GooglePlacesAutocomplete/GooglePlacesAutocomplete.framework"
  install_framework "$BUILT_PRODUCTS_DIR/JLPDFGenerator/JLPDFGenerator.framework"
